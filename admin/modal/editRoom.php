    ...
    <div id="modal">
        <div class="modal-container">
            ...
            <form action="../server/admin/room/createRoom.php" method="post" enctype="multipart/form-data">
            <div class="modal-body">
                    ...
                    <div class="row" style="display:flex; gap:1rem;">
                        <div class="group-inp" style="width:100%;">
                            <label for="file_Image">รูปภาพห้อง</label>
                            <input type="file" name="Image" id="file_Image" style="width:100%;" <?php echo $_GET['stt'] == 'view' ? 'disabled' : '' ?>>
                        </div>
                        
                        
                    </div>
                    <img src="../static/room/m/MA2105.jpg" alt="" id="preview_image" style="max-width:100%; margin-top:1rem">

                        <label style="font-size: 20px;">สิ่งอำนวยความสะดวก</label>
                    <div class="row" style="display:flex; gap:1rem;" >
                        <div style="width:50%;">
                        <p for="tc">
