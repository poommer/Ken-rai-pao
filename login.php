...
<body>
    ...
    <div class="container">
        ...
        <div class="head-logo">
            ...
            <div class="head-text">
                <h3>MCR Booking</h3>
                <small>ระบบจองห้องเรียนและห้องประชุม</small>
            </div>
        </div>

        <div class="body-login">
            <div style="max-width:100%; z-index:2;">
                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="340" height="218" viewBox="0 0 869.99994 520.13854" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <circle cx="524.99994" cy="335.5" r="16" fill="#8e49ff" />
                    ...
                    <path d="M814.17958,522.54937H740.13271l.08911-.57617c.13306-.86133,13.19678-86.439,3.56177-114.436a11.813,11.813,0,0,1,6.06933-14.5835h.00025c13.77173-6.48535,40.20752-14.47119,62.52,4.90918a28.23448,28.23448,0,0,1,9.45947,23.396Z" transform="translate(-165.00003 -189.93073)" fill="#8e49ff" />
                    <path d="M754.35439,448.1812,721.01772,441.418l15.62622-37.02978a13.99723,13.99723,0,0,1,27.10571,6.99755Z" transform="translate(-165.00003 -189.93073)" fill="#8e49ff" />
                    <path d="M797.05043,460.73882l-2.00415-45.94141c-1.51977-8.63623,3.42408-16.80029,11.02735-18.13476,7.60547-1.32959,15.03174,4.66016,16.55835,13.35986l7.533,42.92774Z" transform="translate(-165.00003 -189.93073)" fill="#8e49ff" />
            ...
            <h3 style="font-size: 24px; margin-top:10px;">welcome to MCR Booking</h3>
        </div>


        <div class="form-zone">
            <h1 style="color:#ECC16B;">เข้าสู่ระบบ</h1>
            <small>หากลืมรหัสผ่าน แจ้งแอดมิน</small>
            <form action="server/login_server.php" method="post" style="width:100%; margin-top:2rem; display:flex;  flex-direction:column; justify-content:center; align-items:center; gap:2rem;">
                <div class="group-inp">
